...
assert(
  contracts.expectedWaveCounts?.Hooks === 7,
  "expectedWaveCounts.Hooks must be 7",
);
assert(
...
// The homepage catalog is the fifth contract-derived build output, and until now nothing
