...
//
// The larger `classify-change.mjs` this replaces also answered which browser gates a local receipt
// had to carry. Receipts are gone and PR CI now executes deterministic affected tests directly;
