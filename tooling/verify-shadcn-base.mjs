...
const result = spawnSync(
  "pnpm",
  ["--dir", docsDir, "exec", "shadcn", "info", "--json"],
  {
    encoding: "utf8",
...
if (base !== "base") {
  console.error(
    `Expected apps/docs shadcn base to resolve as "base"; got "${base}".`,
  );
  process.exit(1);
}
...
if (componentDocs.includes("/radix/") || uiSource.includes("/bases/radix/")) {
  console.error(
    "apps/docs shadcn links still point at Radix upstream sources.",
  );
  process.exit(1);
}
