...
:root {
  ...
  --font-cursorgothic:
    "CursorGothic", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
    "Segoe UI", Roboto, sans-serif;
  --font-berkeleymono:
    "berkeleyMono", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas,
    monospace;
  --font-eb-garamond:
    "EB Garamond", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
    "Segoe UI", Roboto, sans-serif;
  --font-lato:
    "Lato", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
    "Segoe UI", Roboto, sans-serif;
  --font-apple-system:
