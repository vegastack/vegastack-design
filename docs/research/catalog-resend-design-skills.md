...
> Durable reference. Source: `/Users/kmanojkumar/code/references/resend-design-skills`, read end-to-end 2026-06-20. This is our primary model for how to structure design *skills* for AI agents. Preserve in full — used when designing the `vegastack-*` skill suite.
