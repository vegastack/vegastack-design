...
{ "$schema": "https://turborepo.dev/schema.json",
  "tasks": {
    "build":     { "dependsOn": ["^build"], "outputs": ["dist/**", ".open-next/**", ".next/**", "build/**", "!.next/cache/**"] },
...
`package.json`:
```jsonc
{ "name": "@vegastack/ui", "repository": "https://github.com/VegaStack/vegastack-design.git",
...
- **Setup:**
  ...
  `wrangler.jsonc`:
  ```jsonc
  { "main": ".open-next/worker.js", "name": "vegastack-design-docs",
