...
| complete browsers          | 1m39 historical working figure                                                                 | 432.478s, 299.259s, and 289.395s complete three-engine reports; range 4m49s–7m12s                                                                                                                                                                                                                                                           | measured local `n=3`; thermal/cold unknown                 | pass, substantial regression/bottleneck                |
| registry build/idempotency | roughly 2–5s warm                                                                              | 4.385s                                                                                                                                                                                                                                                                                                                                      | measured local `n=1`                                       | pass                                                   |
| full consume               | 237.33s accumulating baseline                                                                  | 395.819s, 368.207s, and 336.487s isolated/full; repaired clean-artifact standalone full oracle 335.051s                                                                                                                                                                                                                                     | measured local ship `n=3` plus focused current `n=1`       | **not met**; isolation/artifact cost retained          |
| all contracts              | four historical full receipts 566–1,884s                                                       | 1,698.612s, 1,098.710s, and 869.197s gate reports; each 108/864, zero fail/skip/flake                                                                                                                                                                                                                                                       | measured local `n=3`                                       | pass, main ship bottleneck                             |
| total full ship            | about 19–20m derived                                                                           | 2,905.154s (48m25s), 2,277.227s (37m57s), and 1,815.185s (30m15s); sample median 37m57s                                                                                                                                                                                                                                                     | measured local `n=3`; cache/cold and CPU/RSS unknown       | **not met**; no p50/p95 claim from three samples       |
...
| warm full ship p50≤19m/p95≤22m                                      | derived 19–20m                 | retained range 30m15s–48m25s, sample median 37m57s; contracts and browsers dominate  | `n=3`; identical required coverage retained | not met; percentiles unproven at this sample   |
...
| negative test    | a pack manifest containing only `package.json`/bin fails on the first missing exported `dist/*` target; structured reports missing build/export validation also fail                                                                                                                                                                     |
