...
| remediation | `8c5e4ff4`, `31a32ee8`, `d1655e83`, `f12f24ff`, `78db32a0`, `9e1211ab`, `5b87b1cf`, `f653e49d`, `9546a03b`, `fa33e08a`, `f47a7429`, `9607aaeb`, `ae0ab27b`, `6657877f`; current docs, machine authority, workflow/CLI verifiers, runner diagnostics, deploy probe, VRT/package harness | stale topology/count/timing/provenance/preflight/retry/terminal/browser-location/command/visual-handoff/clean-artifact claims fail semantically; diagnostics use supported package commands/wrappers and structured nonempty terminal reports; receipt formatting remains generator-owned; consume builds and validates packed public exports; derived authority digests are regenerated | active correctness surfaces; each commit independently revertible, but reverting reopens its recorded finding                        | operator verifier covers 33 surfaces, 42 semantic fixtures and 9 executable help surfaces; workflow verifier has 52 mutations |
...
| complete browsers          | 1m39 historical working figure                                                                 | 432.478s, 299.259s, 289.395s, and 242.899s complete three-engine reports; range 4m03s–7m12s                                                                                                                                                                                                                                                 | measured local `n=4`; thermal/cold unknown                 | pass, substantial regression/bottleneck                |
| registry build/idempotency | roughly 2–5s warm                                                                              | 4.385s                                                                                                                                                                                                                                                                                                                                      | measured local `n=1`                                       | pass                                                   |
| full consume               | 237.33s accumulating baseline                                                                  | ship: 395.819s, 368.207s, 336.487s, 333.183s; repaired clean-artifact standalone full oracle 335.051s                                                                                                                                                                                                                                       | measured local ship `n=4` plus focused current `n=1`       | **not met**; isolation/artifact cost retained          |
| all contracts              | four historical full receipts 566–1,884s                                                       | 1,698.612s, 1,098.710s, 869.197s, and 991.101s gate reports; each 108/864, zero fail/skip/flake                                                                                                                                                                                                                                             | measured local `n=4`                                       | pass, main ship bottleneck                             |
| total full ship            | about 19–20m derived                                                                           | 2,905.154s (48m25s), 2,277.227s (37m57s), 1,815.185s (30m15s), and 1,845.050s (30m45s); sample median 34m21s                                                                                                                                                                                                                                | measured local `n=4`; cache/cold and CPU/RSS unknown       | **not met**; no p50/p95 claim from four samples        |
...
| warm full ship p50≤19m/p95≤22m                                      | derived 19–20m                 | retained range 30m15s–48m25s, sample median 34m21s; contracts and browsers dominate  | `n=4`; identical required coverage retained | not met; percentiles unproven at this sample   |
...
| release-bearing end-to-end 45–55m                                   | modeled 70–100m                | cannot support reduction while full ship alone remains 30m15s–48m25s                 | modeled, external `n=0`                     | not met/proven                                 |
| zero selector escapes                                               | none                           | no qualifying cohort                                                                 | `0/30`; full oracle retained                | blocked                                        |
| zero current-instruction drift                                      | known contradictions           | 33 current surfaces pass; 42 semantic mutations and machine-derived 108/864/5 counts | executable local proof                      | met locally                                    |
...
| receipt serialization versus staged formatting                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | a freshly generated, semantically valid production-full receipt must remain committable without hand-editing; keep `.gates/receipt.json` under the atomic generator's deterministic formatting authority and verify its schema/tree/leaves independently |
...
- [x] The committed receipt remains atomic, deterministic machine output; the staged formatter does
      not rewrite it after ship, and receipt verification—not prose formatting—owns correctness.
...
- [x] Consume explicitly builds the public packages and rejects a packed artifact missing any
      declared export/bin target; ignored output from an earlier command cannot supply the proof.
...
### 16.8 Clean package-artifact remediation

| field            | record                                                                                                                                                                                                                                                                                                                                   |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| invariant        | clean release preflight must prove the exact local public packages without borrowing ignored build output from an earlier command                                                                                                                                                                                                        |
| negative test    | a pack manifest containing only `package.json`/bin fails on the first missing exported `dist/*` target; non-relative/escaping targets fail; structured reports with missing, duplicate, unexpected, unbuilt, or unvalidated package artifacts fail independently                                                                         |
| implementation   | build tokens then design, pack with JSON output, validate every relative export/bin target, and retain package/version/build/file-count evidence before consumers                                                                                                                                                                        |
| rollout flag     | none: this closes a fail-open prerequisite in the existing unconditional full oracle; affected reuse remains shadow-only under D1                                                                                                                                                                                                        |
| rollback         | revert the isolated artifact helper/verifier/docs commit, which restores the known order-dependent failure and is therefore not a safe release state                                                                                                                                                                                     |
| documentation    | ship preflight, release gotchas, `docs/RELEASING.md`, primary-source research, and all three append-only ledgers updated together                                                                                                                                                                                                        |
| approval         | locally authorized correctness fix; no outward operation or D1–D7 checkpoint crossed                                                                                                                                                                                                                                                     |
| focused evidence | clean-output diagnostic passed 1/1 real and 1/1 simulated Button root; widened full report passed 26/26 real, 26/26 isolated simulated, and 554/554 consolidated items in both layouts in 335.051s; both runs validated 9 token and 33 design archive files; clean preflight and a fresh exact-tree receipt remain required after commit |

### 16.9 Final adversarial review and freeze rule

- Repeated unchanged-scope review after artifact target canonicalization: **0 high / 0 medium**; no
  earlier finding recurred.
- Current operator surfaces: 33; semantic negative fixtures: 42; CLI help surfaces: 9; workflow
  security mutations: 52.
- The fourth retained full sweep measured 1,845.050s with complete coverage but its receipt was
