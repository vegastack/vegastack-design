...
**Order is deliberate:** provider first (it's the one missing consumable), starter second (validates everything for real), guide third (documents what is *proven*, not what is hoped).
