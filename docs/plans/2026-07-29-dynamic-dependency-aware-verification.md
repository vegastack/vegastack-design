...
| Non-atomic VRT report, unstructured skip/execution, missing digest, receipt promotion                                             | Five report mutations reject.                                                                       | Atomic report writer; explicit safely-skipped/executed-pass/executed-fail states; selector digest; human-review-only eligibility.                                                         |
