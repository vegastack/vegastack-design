...
- [MATRIX] none needed — a decorative-vs-semantic grid wouldn't reveal a _visual_ difference (the difference is ARIA-only, already covered by the attribute table mdx:50–54).
- [API] none.
