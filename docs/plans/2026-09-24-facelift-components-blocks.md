...
- [x] **Task 16: doctrine lines for 00d's next doctrine PR** (rev 2: the removal's lines moved to task 1; what remains is the roster of the NEW blocks and `transcript`/AudioPlayer `docked`)
