...
**What this is:** MK reviews components in the live preview and sends feedback as **voice-recording transcripts**. Each transcript → a surgical, *systemic* fix in the design-system library.
