...
> **Historical record — do not execute.** The v2 rollout is complete. “DO NOT STOP,” autonomous
> authority, counts, paths, and gate results below applied only to that finished run. Current work is
> governed by `AGENTS.md` and the applicable repo skill.
