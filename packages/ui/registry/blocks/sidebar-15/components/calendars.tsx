// @vegastack sidebar-15@0.15.0 sha256-R8CnZ4kuDXxU7XPKS6sroUygg0xCaKevkAuAmqw6H58=
        ...
        <React.Fragment key={calendar.name}>
          <SidebarGroup key={calendar.name}>
            ...
            >
              ...
              >
                {calendar.name}{" "}
                <ChevronRightIcon className="ms-auto transition-transform group-data-open/collapsible:rotate-90" />
              </SidebarGroupLabel>
              <CollapsibleContent>
                <SidebarGroupContent>
                  <SidebarMenu>
