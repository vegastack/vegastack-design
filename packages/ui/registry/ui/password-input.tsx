// @vegastack password-input@0.1.0 sha256-TRjWmBLeufyKGOqMY8l8El6dz1TAXlgok2W1lXVMquw=
...
const requirementClasses =
  "flex items-center gap-1.5 text-sm transition-colors duration-fast ease-standard";
...
export function PasswordInput({
    ...
    const describedBy =
      [
        ariaDescribedBy,
        hasRequirements ? requirementsId : undefined,
        hasRequirements ? requirementsStatusId : undefined,
      ]
        .filter(Boolean)
        .join(" ") || undefined;
        ...
        <Input
          ...
          suffix={
            <button
              ...
              className={cn(
                "flex size-(--size-xs) items-center justify-center rounded-md text-muted-foreground transition-colors duration-fast ease-standard",
            ...
            >
               ...
               */}
              {visible ? (
                <EyeOff key="eye-off" className="size-(--icon-default) motion-pop-in" aria-hidden />
              ) : (
                <Eye key="eye" className="size-(--icon-default) motion-pop-in" aria-hidden />
              )}
            </button>
          }
          {...props}
          ...
          <>
            ...
            >
              {requirementItems.map((req) => (
                ...
                >
                  {req.met ? (
                    <Check className="size-(--icon-inline) shrink-0" aria-hidden />
                  ) : (
