// @vegastack icon-alarm-clock-check@0.4.1 sha256-4qzkV9zCu4TF1lnpQOM1QQ42r6IliOjWcguN72/zSY4=
...
interface AlarmClockCheckIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number | string;
  ref?: React.Ref<AlarmClockCheckIconHandle>;
}
