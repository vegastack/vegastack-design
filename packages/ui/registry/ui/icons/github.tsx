// @vegastack icon-github@0.6.0 sha256-h00ubXiOFgjGgTPFLzLdMq3U9G+MRLDx7xu3KGcfn9g=
...
export const GithubIcon = createAnimatedIcon({
  ...
  start: async ({ controls, run }) => {
    ...
    await run(controls.tail, "draw");
    run(controls.tail, "wag");
  },
  stop: ({ controls, reset }) => {
    reset(controls.body, "normal");
    reset(controls.tail, "normal");
  },
});
