// @vegastack icon-chess-pawn@0.6.0 sha256-Gde7aT5yzo06mTEg5kMJdfBTvXUDRgI5tr+LFjwA2Pw=
...
export const ChessPawnIcon = createAnimatedIcon({
  ...
  groups: ["head", "body"],
  start: ({ controls, run }) => {
    run(controls.head, "animate");
    run(controls.body, "animate");
  },
  stop: ({ controls, reset }) => {
    reset(controls.head, "normal");
    reset(controls.body, "normal");
  },
});
