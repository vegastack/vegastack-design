// @vegastack icon-flask@0.23.33 sha256-SoLSryNz4Xzi2tfOlKKbKi6Yl5BM3M1KZYMl0g8d/O8=

// Mirrored from lucide-animated (https://lucide-animated.com/r/flask.json) — MIT.
...
export type FlaskIconHandle = AnimatedIconHandle;

export const FlaskIcon = createAnimatedIcon({
  name: "FlaskIcon",
  svg: { viewBox: "0 0 512 512", fill: "currentColor", strokeWidth: "5.632" },
  elements: [
    {
      tag: "motion.g",
      variants: { normal: { rotate: 0, translateY: 0 }, animate: { translateY: -12, rotate: [0, 5, -5, 3, -3, 0], transition: { ease: "linear", rotate: { duration: 0.8 } } } },
      children: [
        { tag: "circle", cx: "151.273", cy: "407.273", r: "11.636" },
        { tag: "circle", cx: "244.364", cy: "372.364", r: "11.636" },
        { tag: "circle", cx: "290.909", cy: "418.909", r: "11.636" },
        { tag: "circle", cx: "221.091", cy: "453.818", r: "11.636" },
        { tag: "circle", cx: "372.364", cy: "430.545", r: "11.636" },
      ],
    },
    {
      tag: "motion.path",
      ...
      variants: {
        ...
        animate: { scale: 0.9, rotate: [0, 6, -6, 3, -3, 0], transition: { duration: 0.8, scale: { duration: 0.3, type: "spring", bounce: 0.4, stiffness: 150, damping: 10 } } },
      },
    },
  ],
});
