// @vegastack icon-receipt-euro@0.3.0 sha256-bwkravsHriO0yRh0qztSI+yUrUQwahYkxTIXLF3wWvQ=
...
interface ReceiptEuroIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number | string;
  ref?: React.Ref<ReceiptEuroIconHandle>;
}
