// @vegastack icon-receipt-turkish-lira@0.3.0 sha256-EzoVgZYnKNgSXce35hhREwnSxiUa2j6NER1Gbwr+yqU=
...
interface ReceiptTurkishLiraIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number | string;
  ref?: React.Ref<ReceiptTurkishLiraIconHandle>;
}
