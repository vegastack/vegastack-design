// @vegastack icon-receipt-turkish-lira@0.23.31 sha256-vookhUoTxlmokYHFREznQu1ZQ2jfWgyXZlOwQo2gWuQ=
...
export type ReceiptTurkishLiraIconHandle = AnimatedIconHandle;

export const ReceiptTurkishLiraIcon = createAnimatedIcon({
  name: "ReceiptTurkishLiraIcon",
  svg: { tag: "motion.svg", inherit: true },
  elements: [
    { tag: "motion.path", d: "M10 7v10a5 5 0 0 0 5-5", variants: LIRA_MAIN_VARIANTS, initial: "normal" },
    { tag: "motion.path", d: "m14 8-6 3", variants: LIRA_SECONDARY_VARIANTS, initial: "normal" },
