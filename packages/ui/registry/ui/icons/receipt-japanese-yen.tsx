// @vegastack icon-receipt-japanese-yen@0.23.41 sha256-5d8RutaigQcY/uQiml8YreEVDinZDTW56/7eas2nl9I=

// Mirrored from lucide-animated (https://lucide-animated.com/r/receipt-japanese-yen.json) — MIT.
...
export type ReceiptJapaneseYenIconHandle = AnimatedIconHandle;

export const ReceiptJapaneseYenIcon = createAnimatedIcon({
  name: "ReceiptJapaneseYenIcon",
  svg: { tag: "motion.svg", inherit: true },
  elements: [
    { tag: "motion.path", d: "m12 10 3-3", variants: JAPANESE_YEN_MAIN_VARIANTS, initial: "normal" },
    ...
    { tag: "motion.path", d: "M9 11h6", variants: JAPANESE_YEN_SECONDARY_VARIANTS, initial: "normal" },
    { tag: "motion.path", d: "M9 15h6", variants: JAPANESE_YEN_SECONDARY_VARIANTS, initial: "normal" },
    { tag: "motion.path", d: "m9 7 3 3v7", variants: JAPANESE_YEN_MAIN_VARIANTS, initial: "normal" },
  ],
});
