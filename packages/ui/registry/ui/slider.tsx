// @vegastack slider@0.2.0 sha256-OJwO5XvuUT1dMvFM6HafzCQdvPa+UuDoIc6hGidoTAM=
            ...
            return (
              <BaseSlider.Thumb
                ...
                className={cn(
                  ...
                  // 24×24 CSS px minimum, so a `before:absolute before:-inset-1` pseudo-element
                  // brings the effective drag/tap target to 24×24 (16 + 2×4) without resizing the
                  // dot. No `relative` needed — Base UI already renders the thumb with an inline
