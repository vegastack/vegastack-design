...
// Manual audit lane: the complete browser-unit suite in Chromium, WebKit, and Firefox. Pull requests
// use deterministic affected Chromium selection; publication and deployment do not repeat component
// regression.
  ...
  mergeConfig(
    ...
    defineConfig({
      test: {
        ...
        // ONE retry, manual all-engine audit only. Measured 2026-09-09 on a loaded Mac: two Firefox tests
        ...
        // of a complete audit re-run. A test that fails twice still fails the lane.
        retry: 1,
        browser: {
          enabled: true,
          headless: true,
