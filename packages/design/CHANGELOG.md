...
- [#286](https://github.com/vegastack/vegastack-design/pull/286) [`2c9582f`](https://github.com/vegastack/vegastack-design/commit/2c9582f887c14a0d389346e13002f76cadaa3b80) Thanks [@kmanojkumar](https://github.com/kmanojkumar)! - 🔧 Row actions: `RowActionItem` gains an optional `submenu` slot — custom content (a searched, paged list such as Assign › members) rendered inside the submenu after `items`.

- [#282](https://github.com/vegastack/vegastack-design/pull/282) [`c6ea931`](https://github.com/vegastack/vegastack-design/commit/c6ea931d7dd81bceacc0cb0bea1c9898e26fb69f) Thanks [@kmanojkumar](https://github.com/kmanojkumar)! - 🔧 NotificationBell: the count badge is a solid destructive fill (was a faded tint) and the unread dot is solid info blue (was primary ink); both sit inside the button's top inline-end corner with a background ring, so they never spill out when pressed. Counts cap at "99+" with a matching "99+ unread" accessible name.
