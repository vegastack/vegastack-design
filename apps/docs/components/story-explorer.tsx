...
export function StoryExplorer({ children }: { children: ReactNode }) {
  return (
    <div
      data-story-explorer=""
      className="not-prose my-4 overflow-hidden rounded-lg border border-border bg-card [&>div]:border-0 [&>div>*:nth-child(2)]:flex [&>div>*:nth-child(2)]:min-h-32 [&>div>*:nth-child(2)]:items-center [&>div>*:nth-child(2)]:justify-center [&>div>*:nth-child(2)]:p-6"
    >
      {children}
    </div>
  );
