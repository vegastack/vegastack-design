...
const FORMATS: Record<string, { options?: Intl.NumberFormatOptions; code?: string }> = {
  none: {},
  currency: {
...
const animatedNumberPlaygroundConfig: PlaygroundConfig<AnimatedNumberPlaygroundKey> = {
  controls: [
    { type: 'select', key: 'value', label: 'Value', options: VALUE_OPTIONS, defaultValue: '1204' },
    { type: 'select', key: 'format', label: 'Format', options: FORMAT_OPTIONS, defaultValue: 'none' },
    { type: 'select', key: 'duration', label: 'Duration', options: DURATION_OPTIONS, defaultValue: 'base' },
  ],
