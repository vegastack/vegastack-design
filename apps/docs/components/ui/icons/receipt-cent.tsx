// @vegastack icon-receipt-cent@0.6.0 sha256-am8XFFgIVaoZNwZ4beAhvgh2uVcakcNnLVnTMhLai30=
...
interface ReceiptCentIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number | string;
  ref?: React.Ref<ReceiptCentIconHandle>;
}
