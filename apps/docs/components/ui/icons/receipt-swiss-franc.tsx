// @vegastack icon-receipt-swiss-franc@0.4.1 sha256-lIib2S1qCANJXyICaT4JOCWRHO3UKQYmIvOKMJ5kOQE=
...
interface ReceiptSwissFrancIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number | string;
  ref?: React.Ref<ReceiptSwissFrancIconHandle>;
}
