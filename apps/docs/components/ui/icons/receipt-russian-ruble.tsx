// @vegastack icon-receipt-russian-ruble@0.2.0 sha256-tqVB6SIf6l9HgDUtVj2l0AVgaszKZGDHDFoJFl+zpmE=
...
interface ReceiptRussianRubleIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number | string;
  ref?: React.Ref<ReceiptRussianRubleIconHandle>;
}
