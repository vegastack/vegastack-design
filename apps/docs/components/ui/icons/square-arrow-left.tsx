// @vegastack icon-square-arrow-left@0.3.0 sha256-Cwq7uQ4pfY6HE/gOhnMvZvmpJnEkTGohrRddEuB7bTo=
...
interface SquareArrowLeftIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number | string;
  ref?: React.Ref<SquareArrowLeftIconHandle>;
}
