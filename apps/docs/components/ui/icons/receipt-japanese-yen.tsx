// @vegastack icon-receipt-japanese-yen@0.2.0 sha256-egdXeFdy9fvMBDAFYltSmr8KINHa0dI0Dx874JLCf8s=
...
interface ReceiptJapaneseYenIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number | string;
  ref?: React.Ref<ReceiptJapaneseYenIconHandle>;
}
