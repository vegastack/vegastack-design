// @vegastack icon-square-arrow-down@0.3.0 sha256-HTlztrzTCuMlmVAD3VfmjVF3hm6nrS6q83vQ8HaoYZ4=
...
interface SquareArrowDownIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number | string;
  ref?: React.Ref<SquareArrowDownIconHandle>;
}
