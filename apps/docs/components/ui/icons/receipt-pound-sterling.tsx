// @vegastack icon-receipt-pound-sterling@0.3.0 sha256-8FC2UA3G0/GosnsJ1h/M0idCHLMbaN7Rnrp8GaHuTS0=
...
interface ReceiptPoundSterlingIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number | string;
  ref?: React.Ref<ReceiptPoundSterlingIconHandle>;
}

const ReceiptPoundSterlingIcon = ({
  onMouseEnter,
  onMouseLeave,
  className,
