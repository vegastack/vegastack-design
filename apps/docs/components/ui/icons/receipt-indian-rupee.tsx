// @vegastack icon-receipt-indian-rupee@0.5.0 sha256-l+7jsj+Q7FeDex3VoJ3kHkEnTfyXurGSlfqw1GZo09g=
...
interface ReceiptIndianRupeeIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number | string;
  ref?: React.Ref<ReceiptIndianRupeeIconHandle>;
}
