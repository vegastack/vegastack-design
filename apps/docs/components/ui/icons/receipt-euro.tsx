// @vegastack icon-receipt-euro@0.23.14 sha256-POZaKEWLZ20Cv7SZKRLIbj4GDeeWKsnFQutn7h3Sbc4=

// Mirrored from lucide-animated (https://lucide-animated.com/r/receipt-euro.json) — MIT.
...
export type ReceiptEuroIconHandle = AnimatedIconHandle;

export const ReceiptEuroIcon = createAnimatedIcon({
  name: "ReceiptEuroIcon",
  svg: { tag: "motion.svg", inherit: true },
  elements: [
    { tag: "motion.path", d: "M15.828 14.829a4 4 0 0 1-5.656 0 4 4 0 0 1 0-5.657 4 4 0 0 1 5.656 0", variants: EURO_MAIN_VARIANTS, initial: "normal" },
    ...
    { tag: "motion.path", d: "M8 12h5", variants: EURO_SECONDARY_VARIANTS, initial: "normal" },
  ],
});
