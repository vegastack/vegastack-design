// @vegastack toggle-group@0.1.0 sha256-5bMC/WHpa7uPW2nOQcd5I/ezadFKcBT29aOnQvlJcNM=
...
export interface ToggleGroupProps
  extends Omit<React.ComponentProps<typeof BaseToggleGroup>, 'value' | 'defaultValue'>,
...
export function ToggleGroup(
    ...
    const contextValue = React.useMemo<ToggleGroupContextValue>(() => ({ size }), [size]);
    const rootClassName =
    ...
    const resolvedClassName: React.ComponentProps<typeof BaseToggleGroup>['className'] =
 ...
 * joined control.
 */
export function ToggleGroupItem({ className, size, children, ref, ...props }: ToggleGroupItemProps) {
    ...
    const resolvedClassName: React.ComponentProps<typeof BaseToggle>['className'] =
      typeof className === 'function'
