      ...
      <AlertDialog>
        ...
        <AlertDialogContent intent="destructive">
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction intent="destructive">
              Delete project
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
...
const INTENTS: {
...
}[] = [
  {
    ...
    description:
      "This makes version 2.0 available to everyone in your workspace.",
    confirm: "Publish",
  },
  {
    intent: "destructive",
  ...
  },
  {
    ...
    description:
      "Existing keys stop working immediately. Integrations must be reconnected.",
    confirm: "Reset keys",
  },
];
...
export function alertDialogScrollable(): ReactNode {
  return (
    <Wrapper>
      <AlertDialog>
        <AlertDialogTrigger
          render={<Button variant="outline">Review terms</Button>}
        />
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Accept updated terms?</AlertDialogTitle>
            <AlertDialogDescription>
              Review the full terms below before continuing. You must accept to
