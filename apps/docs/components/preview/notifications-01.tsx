...
/**
 * `preview/notifications-01.tsx` — the docs live preview for the `notifications-01` registry block.
 *
...
import Notifications01Page from "../../../../packages/ui/registry/blocks/notifications-01/page";
