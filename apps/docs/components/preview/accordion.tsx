    ...
    <Wrapper>
      <Accordion defaultValue={["what"]} className="max-w-md">
        <AccordionItem value="what">
          ...
          <AccordionContent>
            A token-driven component system built on Base UI and Tailwind,
            distributed as a private shadcn registry.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="install">
          <AccordionTrigger>How do I install a component?</AccordionTrigger>
          <AccordionContent>
            Run the shadcn CLI with the registry alias to copy the source
        ...
        <AccordionItem value="theme">
          ...
          <AccordionContent>
            Yes — every value maps to a semantic token, so light and dark themes
            flow from the token layer.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </Wrapper>
    ...
    <Wrapper>
      ...
      >
        <AccordionItem value="shipping">
          ...
          <AccordionContent>
            Orders ship within 2–3 business days. Tracking is emailed once the
            carrier scans your package.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="returns">
          <AccordionTrigger>Returns</AccordionTrigger>
          <AccordionContent>
            Unused items can be returned within 30 days for a full refund to the
        ...
        <AccordionItem value="warranty" disabled>
          ...
          <AccordionContent>
            Warranty details are not yet available.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </Wrapper>
