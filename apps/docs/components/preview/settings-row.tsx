...
import { SettingsCard, SettingsRow, SettingsSection } from '@/components/ui/settings-row';
  ...
  return (
    <Wrapper className="block">
      <SettingsCard className="mx-auto w-full max-w-md">
        <SettingsRow label="Email notifications" description="Product updates, tips, and offers.">
          <Switch defaultChecked aria-label="Email notifications" />
        </SettingsRow>
        <SettingsRow label="Theme" description="How the interface looks on this device.">
        ...
        <SettingsRow label="Two-factor authentication" description="Require a code at sign-in.">
    ...
    <Wrapper className="block">
      ...
      >
        <SettingsCard>
          ...
          <SettingsRow label="Desktop push" description="Real-time alerts on this device.">
    ...
    <Wrapper className="block">
      <SettingsCard className="mx-auto w-full max-w-md">
        ...
        <SettingsRow label="Display name" controlId="settings-display-name">
          <Input id="settings-display-name" defaultValue="Ada" className="w-44" />
        </SettingsRow>
        {/* Switch control */}
        <SettingsRow label="Email notifications" description="Product updates and tips.">
          <Switch defaultChecked aria-label="Email notifications" />
        </SettingsRow>
        {/* Read-only value */}
        <SettingsRow label="Workspace ID" description="Used in API requests.">
          <span className="font-mono text-base text-muted-foreground">ws_8f3a1c</span>
        </SettingsRow>
        {/* Badge as status */}
        ...
        {/* Button control */}
        <SettingsRow label="Active sessions" description="Sign out everywhere else.">
