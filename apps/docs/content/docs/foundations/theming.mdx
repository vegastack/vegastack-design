...
Change `--primary` and `--color-primary` follows automatically, so `bg-primary`, every alpha wash
of it (`hover:bg-primary/80`, `active:bg-primary/70`), and the `--ring`-keyed focus outline all
repaint at once.
...
:root {
  ...
  --primary/80: oklch(0.48 0.189 295);
  --primary/70: oklch(0.44 0.189 295);
