---
title: sidebar-02
description: A sidebar with collapsible sections. Composed from breadcrumb, collapsible, dropdown-menu, label.
audience: public
registry: sidebar-02
preview: sidebar02Demo
---
...
```npm
npx shadcn@latest add @vegastack/sidebar-02
```

<RegistryInstallCallout />

This installs the block's own files plus the components it composes: `breadcrumb`, `collapsible`, `dropdown-menu`, `label`, `separator`, `sidebar`.

## Preview

<ComponentPreview name="sidebar02Demo" />
