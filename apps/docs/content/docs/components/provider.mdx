...
<ComponentPreview name="providerTooltips" file="components/preview/provider.tsx" />
...
<AutoTypeTable path="../../packages/ui/registry/ui/provider.tsx" name="VegaStackProviderProps" />
