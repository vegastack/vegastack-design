...
<InstallSteps name="progress-indicator" />
...
that is the form [`OnboardingChecklist`](/docs/components/onboarding-checklist) composes.
...
<StatesTested name="progress-indicator" />
...
<ComponentChangelog name="progress-indicator" />
