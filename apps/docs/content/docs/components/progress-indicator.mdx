...
<ComponentPreview name="progressIndicator" file="components/preview/progress-indicator.tsx" />
...
<ComponentPreview name="progressIndicatorValues" file="components/preview/progress-indicator.tsx" />

### Shapes

`shape` controls the outline: a true `circle` ring or a rounded-square `squircle`.

<ComponentPreview name="progressIndicatorShapes" file="components/preview/progress-indicator.tsx" />

### Sizes

`xs` (14px), `sm` (16px), `default` (20px), and `lg` (24px) — mapped to the `size-*` token scale.

<ComponentPreview name="progressIndicatorSizes" file="components/preview/progress-indicator.tsx" />
...
<ComponentPreview name="progressIndicatorColors" file="components/preview/progress-indicator.tsx" />
...
<ComponentPreview name="progressIndicatorCustomScale" file="components/preview/progress-indicator.tsx" />
...
<ComponentPreview name="progressIndicatorSweep" file="components/preview/progress-indicator.tsx" />
...
<ComponentPreview name="progressIndicatorShapeValueMatrix" file="components/preview/progress-indicator.tsx" />

## API Reference

<AutoTypeTable path="../../packages/ui/registry/ui/progress-indicator.tsx" name="ProgressIndicatorProps" />
