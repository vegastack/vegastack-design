...
`attachments` slot at the bottom left. No avatar sits beside it. Editing a comment uses a compact
box with explicit Cancel and Save. The parts take data and
