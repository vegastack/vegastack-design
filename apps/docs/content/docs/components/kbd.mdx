...
one type role, `font-mono text-xs`; `md` previously reached the same 12px through `text-sm`,
...
<ApiTable path="../../packages/ui/registry/ui/kbd.tsx" name="KbdProps" />

### KbdGroup

<ApiTable path="../../packages/ui/registry/ui/kbd.tsx" name="KbdGroupProps" />
