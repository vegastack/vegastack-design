...
description: A getting-started card — a progress bar and step rows, collapsible to a progress pill.
audience: public
...
- The meter is a composed [`Progress`](/docs/components/progress) — one named `progressbar` for the whole card.
