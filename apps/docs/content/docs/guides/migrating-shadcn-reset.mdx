...
| ----------------- | ------------------------- | ---------------------------------------------- |
| `text-h1`         | 24px / 32, w400, -0.02em  | `text-3xl font-semibold` (page heading)        |
| `text-h2`         | 20px / 28, w400, -0.015em | `text-2xl font-semibold` (section heading)     |
...
| A heading lost its size and is body-weight text                | `text-h2` compiled to nothing. Write `text-2xl font-semibold` (section 5). `vegastack-design doctor` lists every one                                                                      |
...
2. `text-h2` → `text-2xl font-semibold`.
