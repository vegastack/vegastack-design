...
export const metadata: Metadata = {
  ...createMetadata({
    ...
    image: {
      ...
      alt: "VegaStack Design — components, tokens, patterns, and implementation guidance",
    },
  }),
  // `metadataBase` is root-only metadata; keep it beside the shared page metadata result.
      ...
      <body className="isolate flex flex-col min-h-screen">
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: serializeStructuredData(siteStructuredData),
          }}
        />
