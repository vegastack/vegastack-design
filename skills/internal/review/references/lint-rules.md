...
6. **`no-surface-ring`** (BRD-1, **ours since MK 2026-09-23**) — a 1px ring width (`ring-1`,
   `ring-px`, `ring-[1px]`, and bare `ring`, which is 1px in Tailwind v4 — matched only inside a
   string literal, since it is also an English word) or a hairline ink (`ring-foreground`,
