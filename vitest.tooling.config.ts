 ...
 *
 * Today it holds two suites: `workspace-clean` (the cleanup script's safety properties) and
 * `registry-integrity` (the on-disk tamper proof). WP3 moves the remaining `tooling/verify-*.mjs`
